...
PROJECT_REPO := github.com/dfarrugia/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION := 1.9.2
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-databricks
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-databricks_v1.9.2_x5
